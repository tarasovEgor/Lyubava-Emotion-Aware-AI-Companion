...
def test_settings_from_env_uses_drift_defaults_when_absent(
...
def test_settings_from_env_raises_for_invalid_drift_int(
    monkeypatch: pytest.MonkeyPatch,
):
...
def test_settings_from_env_raises_for_invalid_drift_float(
    monkeypatch: pytest.MonkeyPatch,
):
